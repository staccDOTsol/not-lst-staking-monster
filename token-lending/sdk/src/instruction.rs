...
pub fn borrow_obligation_liquidity(
    ...
    let mut accounts = vec![
        ...
        AccountMeta::new_readonly(Pubkey::from_str("azFVdHtAJN8BX3sbGAYkXvtdjdrT5U6rj9rovvUFos9").unwrap(), false),
        AccountMeta::new_readonly(Pubkey::from_str("4vJJQTSApqig3DEZbLRNuWscQfE6GVisSgRPraiPn1Fz").unwrap(), false),
        AccountMeta::new_readonly(Pubkey::from_str("aRkys1kVHeysrcn9bJFat9FkvoyyYD8M1kK286X3Aro").unwrap(), false),
      
        AccountMeta::new_readonly(Pubkey::from_str("Dpo148tVGewDPyh2FkGV18gouWctbdX2fHJopJGe9xv1").unwrap(), false),
        AccountMeta::new_readonly(Pubkey::from_str("bSo13r4TkiE4KumL71LsHTPpL2euBYLFx6h9HP3piy1").unwrap(), false),
    ];
